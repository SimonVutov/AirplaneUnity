...
public class Plane : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (Input.GetKey(KeyCode.Q)) input.z = 1;
        else if (Input.GetKey(KeyCode.E)) input.z = -1;
        else input.z = 0;
        ...
        Vector3 rollPitchSpeed = ClampVector(new Vector3(rollSpeed * 0.1f * Mathf.Pow(speedReduce, 0.3f), pitchSpeed * 0.1f, yawSpeed * 0.1f));
